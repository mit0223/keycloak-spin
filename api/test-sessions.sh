...
SPIN_LOG=${SPIN_LOG:-"$SPIN_STATE_DIR/logs/spin-sessions.log"}
...
SESSION_ID=${SESSION_ID:-session-$RANDOM}
...
step "delete session"
read -r code out < <(request DELETE "/admin/realms/$REALM/sessions/$SESSION_ID")
